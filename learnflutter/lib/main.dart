...
void main() {
  runApp(const ExampleWidgetUIApp());
}

class ExampleWidgetUIApp extends StatefulWidget {
  const ExampleWidgetUIApp({super.key});

  @override
  State<ExampleWidgetUIApp> createState() => _ExampleWidgetUIAppState();
}

class _ExampleWidgetUIAppState extends State<ExampleWidgetUIApp> {
  @override
