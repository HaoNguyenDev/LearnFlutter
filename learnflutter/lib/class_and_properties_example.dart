abstract class Verhical {
  ...
  Verhical(String brandNameValue, String modelNameValue, int? yearValue, String? colorValue) {
  ...
  /// Named constructor
  Verhical.constructorNamed(String brandNameValue, String modelNameValue, int? yearValue, String? colorValue) {
    this.brandName = brandNameValue;
    this.modelName = modelNameValue;
    this.year = yearValue;
    this.color = colorValue;
...
class Car extends Verhical {
  ...
  //MARK: Constructor
  Car(super.brandName, super.modelName, super.year, super.color, this._madeIn, this._isElectricVerhical, this.maxSpeed);
  ...
  @override 
  void messageOfBrand() {
    print('VinFast\'s core message revolves around creating a sustainable future through smart, safe, and environmentally friendly electric vehicles');
  }
...
class Bicycle extends Verhical {
  ...
  final String? _madeIn;
  int maxSpeed;
  Bicycle(super.brandName, super.modelName, super.year, super.color,this._madeIn, this.maxSpeed);
  ...
  @override
  void messageOfBrand() {
    print('We are $brandName Bicycle, we just has $numberOfWheel wheels!, max speed is $maxSpeed km/h! Made in $_madeIn');
  }
}
